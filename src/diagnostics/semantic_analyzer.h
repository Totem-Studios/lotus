...
namespace semantics {
    static std::string fatal_error(const std::chrono::high_resolution_clock::time_point& time, const std::string& header, const std::string &description, const std::string &desc_var = "") {
        ...
        std::cerr << "lotus ~ semantic error: " << header << "\n"
    ...
    static std::string nonfatal_error(const std::chrono::high_resolution_clock::time_point& time, const std::string& header, const std::string &description, const std::string &desc_var = "") {
        ...
        return "lotus ~ semantic error: " + header + "\n" + time_spacing + description + desc_var + "\n" + std::string(time_spacing.length(), ' ') + "\n";
    }
}  // namespace semantics
